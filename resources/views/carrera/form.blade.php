<div class="row padding-1 p-1">
    <div class="col-md-12">
        <div class="form-group mb-2 mb20">
            <label for="nombre_carr" class="form-label">{{ __('Nombre Carr') }}</label>
            <input type="text" name="nombre_carr" class="form-control @error('nombre_carr') is-invalid @enderror" value="{{ old('nombre_carr', $carrera?->nombre_carr) }}" id="nombre_carr" placeholder="Nombre Carr">
