...
<div class="home-hero p-4 p-md-5 mb-4">
    <div class="d-flex align-items-center justify-content-between gap-3">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                <h1 class="h3 mb-1">Panel principal Admin</h1>
                <p class="mb-0 opacity-75">Nombre del administrador: Samuel Adrián Ortigoza Luna</p>
                <p class="mb-0 opacity-75">Correo: samuelluna707@gmail.com</p>
            </div>
        </div>
